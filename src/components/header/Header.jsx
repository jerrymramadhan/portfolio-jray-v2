...
window.addEventListener("scroll", function () {
    ...
    // when the scroll is higher than 200 viewport height, ådd the scroll-header class to a tag with the header tag
    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">JRay.</a>
