...
const Data = () => {
    return ( 
        <div className="home__data">
            <h1 className="home__title">Jerry Malano Ramadhan
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">IT Enthusiast</h3>
            <p className="home__description"> I'm IT Enthusiast who like all about IT, and I'm very passionate and dedicated to my work</p>
